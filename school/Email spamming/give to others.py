...
if time.time() > 1556303341:
    raise PermissionError("The free trial has ended. Please purchase the full version.")
#Official Release: You can stop the spam by holding down the grave accent (`) key
...
import sys, os
sys.path.append("C:/users/" + os.getlogin() + "/documents")
